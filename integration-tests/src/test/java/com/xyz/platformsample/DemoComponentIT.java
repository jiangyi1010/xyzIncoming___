 ...
 */
package com.xyz.platformsample;
 ...
 * determined by the @Remote components.rules.config.
 *
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("com.xyz.DemoComponent");
